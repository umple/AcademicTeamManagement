...
import { Box, Button, Typography, Grid, Alert, Snackbar, TableRow, TableCell } from "@mui/material";
...
const MyGroup = () => {
  ...
  return (
    ...
    <Box sx={{ mt: 3 }}>
      ...
      >
        <Alert severity="success">User has left the team successfully!</Alert>
      </Snackbar>
      {loading ? (
        <CircularProgress />
      ) : (
          ...
          {Object.keys(group).length !== 0 ? (
            <Box>
              ...
              <Typography variant="h6">
                Members: {group.members && group.members.join(', ')}
              </Typography>
              {group.project ? (
