...
def add_group():
    try:
        ...
        print("Received group object:", group_obj)
        group_entity = GroupEntity(group_obj)
        print("BIIIIB")
        print(group_entity)
        insert_result, next_group_number = group.add_group(group_obj)
        print(next_group_number)
        print(insert_result)
    

        response_data = {"message": "Group added successfully", "group_number": next_group_number, "id": str(insert_result.inserted_id)}
